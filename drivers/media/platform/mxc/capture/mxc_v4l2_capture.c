...
static int mxc_v4l2_g_ctrl(cam_data *cam, struct v4l2_control *c)
{
	...
	case V4L2_CID_BRIGHTNESS:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gBRIGHTNESS: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_HUE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gHUE: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_CONTRAST:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gCONTRAST: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_SATURATION:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gSATURATION: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_RED_BALANCE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gRED BAL: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_BLUE_BALANCE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gBLUE BAL: slave not found!\n");
			status = -ENODEV;
		}
		break;
	case V4L2_CID_BLACK_LEVEL:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture gBLACK LEVEL: slave not found!\n");
			status = -ENODEV;
		}
		break;
	default:
...
static int mxc_v4l2_s_ctrl(cam_data *cam, struct v4l2_control *c)
{
	...
	case V4L2_CID_HUE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sHUE: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_CONTRAST:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sCONTRAST: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_BRIGHTNESS:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sBRIGHTNESS: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_SATURATION:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sSAT: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_RED_BALANCE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sRED BAL: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_BLUE_BALANCE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sBLUE BAL: slave not found!\n");
			ret = -ENODEV;
		}
		break;
	case V4L2_CID_EXPOSURE:
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture sEXPOSURE: slave not found!\n");
			ret = -ENODEV;
		}
		break;
...
static int mxc_v4l_open(struct file *file)
{
	...
	if (cam->sensor == NULL ||
		...
		pr_err("ERROR: v4l2 capture sensor==NULL: slave not found!\n");
		pr_err("ERROR: DOUBLE CHECK mxc_v4l2_capture.c!\n");
		return -EAGAIN;
	}
			    ...
			    unsigned int ioctlnr, void *arg)
{
	...
	case VIDIOC_G_PARM: {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture gPARAM: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	...
	case VIDIOC_S_PARM:  {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture sPARAM: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	...
	case VIDIOC_G_STD: {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture gSTD: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	...
	case VIDIOC_ENUM_FMT: {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture enumFMT: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	case VIDIOC_ENUM_FRAMESIZES: {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture enumFRAMESZ: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	case VIDIOC_ENUM_FRAMEINTERVALS: {
		...
		if (cam->sensor) {
			...
			pr_err("ERROR: v4l2 capture enumFRAMINT: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
	case VIDIOC_DBG_G_CHIP_IDENT: {
		...
		if (cam->sensor)
			...
			pr_err("ERROR: v4l2 capture gCHIPID: slave not found!\n");
			retval = -ENODEV;
		}
		break;
	}
